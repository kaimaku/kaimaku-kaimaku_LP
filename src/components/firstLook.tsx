  ...
  return (
    <>
      <div className="mb-40 w-screen">
        <img
          src={BackgroundBaseImage.src}
          width={1720}
          height={600}
          className="z-0 w-full hidden md:block"
        />
        <div className="flex flex-col-reverse w-screen md:flex-row md:px-36 absolute top-32">
          <div className="flex flex-col mx-12 max-w-3xl -mt-[550px] md:mt-0">
            ...
            <div>
              <p className="text-[90px] md:text-[52px] font-bold whitespace-nowrap mt-[1000px] md:mt-32 ml-40 md:ml-0">
                大学生活で
                <br />
                何かを本気で
                <br />
          ...
          <div className="relative w-full -ml-20 hidden md:block">
            <img
              src={Layer1.src}
              alt="layer1"
              width={380}
